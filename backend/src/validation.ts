...
/**
 * Login body. Only requires a non-empty password — no username
 * field because this is single-user auth.
 */
...
/**
 * First-run password setup. Enforces a minimum length of 8
 * characters to avoid trivially weak passwords.
 */
...
/**
 * Change password body. Verifies the current password before
